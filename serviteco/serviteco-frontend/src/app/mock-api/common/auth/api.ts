    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                if (request.body['resultado'] == 'OK') {
                    this._user.name = request.body['mensaje'];
                    this._user.admin = request.body['admin'];
                    this._user.id = request.body['id'];
                    this._user.jefe = request.body['jefe'];
                    this._user.distribuidor = request.body['distribuidor'];
                    this._user.importador = request.body['importador'];
                    this._user.taller = request.body['taller'];
                    this._user.company = request.body['company'];
