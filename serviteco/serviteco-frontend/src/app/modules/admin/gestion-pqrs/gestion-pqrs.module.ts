...
import { pqrsRoutes } from './gestion-pqrs.routing';

@NgModule({
    declarations: [
        GestionPqrsComponent,
        GestionPqrsListComponent,
        GestionPqrsDetailComponent,
    ],
    imports     : [
        RouterModule.forChild(pqrsRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class GestionPqrsModule
{
}
