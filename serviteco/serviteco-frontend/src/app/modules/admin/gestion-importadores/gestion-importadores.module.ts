...
import { importadoresRoutes } from './gestion-importadores.routing';
import { FuseCardModule } from '@fuse/components/card';

@NgModule({
    declarations: [
        GestionImportadoresComponent,
        GestionImportadoresListComponent,
        GestionImportadoresDetailComponent,
    ],
    imports     : [
        RouterModule.forChild(importadoresRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class GestionImportadoresModule
{
}
