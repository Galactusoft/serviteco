...
@Component({
    ...
    templateUrl: './reporte-productos-activos.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReporteProductosActivosComponent implements OnInit, OnDestroy {
    ...
    */
    ...
    consultarData() {
        ...
        paginator.identificacion = busqueda.identificacion;
        // Search
        this._gestionReporteService.getProductosActivosImportadorPaginator(paginator).subscribe(data => {
    ...
    exportar(): void {
        const busqueda = this.form.getRawValue();
        this._gestionReporteService.getExportProductosActivosImportadorPaginator(busqueda).subscribe(data => {
            if (data.registros.length > 0) {
                ...
                var footer = [];
                this._gestionReportesService.exportReportAsExcelFile(data.registros, 'reporte_productos_activos_importador', head, footer);
            } else {
                Swal.fire({
