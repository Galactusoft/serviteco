...
@Component({
    selector: 'reporte-repuestos-solicitados',
    templateUrl: './reporte-repuestos-solicitados.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReporteRepuestosSolicitadosComponent implements OnInit, OnDestroy {
    ...
    */
    ...
    consultarData() {
        ...
        // Search
        this._gestionReporteService.getRepuestosSolicitadosImportadorPaginator(paginator).subscribe(data => {
    ...
    exportar(): void {
        ...
        this._gestionReporteService.getExportRepuestosSolicitadosImportadorPaginator(busqueda).subscribe(data => {
            if (data.registros.length > 0) {
                ...
                this._gestionReportesService.exportReportAsExcelFile(data.registros, 'reporte_repuestos_mas_solicitados_importador', head, []);
            } else {
                Swal.fire({
