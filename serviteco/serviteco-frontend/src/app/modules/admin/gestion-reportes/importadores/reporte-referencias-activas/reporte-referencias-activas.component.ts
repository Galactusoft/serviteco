...
@Component({
    selector: 'reporte-referencias-activas',
    templateUrl: './reporte-referencias-activas.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReporteReferenciasActivasComponent implements OnInit, OnDestroy {
