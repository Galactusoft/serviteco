...
@Component({
    selector: 'reporte-repuestos-distribuidor',
    templateUrl: './reporte-repuestos-distribuidor.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReporteRepuestosDistribuidorComponent implements OnInit, OnDestroy {
    ...
    tableColumns: string[] = ['material', 'pieza_fabricante', 'nombre', 'descripcion', 'importador', 'marca', 'referencia', 'categoria'];
    orderBy: string = "1";
    order: string = "asc";
    filter: string = "all";
    pageIndex: number = 0;
    ...
    */
    ...
    consultarData() {
        ...
        // Search
        this._gestionReporteService.getRepuestosDistribuidorPaginator(paginator).subscribe(data => {
    ...
    */
    ...
    exportar(): void {
        ...
        this._gestionReporteService.getExportRepuestosDistribuidorPaginator(busqueda).subscribe(data => {
            if (data.registros.length > 0) {
                var head = ['material', 'pieza_fabricante', 'nombre', 'descripcion', 'marca', 'referencia', 'categoria'];
                this._gestionReportesService.exportReportAsExcelFile(data.registros, 'reporte_repuestos_distribuidor', head, []);
            } else {
                Swal.fire({
