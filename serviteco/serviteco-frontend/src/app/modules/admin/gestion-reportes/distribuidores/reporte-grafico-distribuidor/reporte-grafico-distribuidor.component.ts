...
@Component({
    selector: 'reporte-grafico-distribuidor',
    templateUrl: './reporte-grafico-distribuidor.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReporteGraficoDistribuidorComponent implements OnInit, OnDestroy {
