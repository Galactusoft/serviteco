...
@Component({
    selector: 'reporte-importadores-activos',
    templateUrl: './reporte-importadores-activos.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReporteImportadoresActivosComponent implements OnInit, OnDestroy {
