...
import { tipoProductosRoutes} from './gestion-tipoProductos.routing';

@NgModule({
    declarations: [
        GestionTipoProductosComponent,
        GestiontipoProductosListComponent,
        GestionTipoProductoDetailComponent
    ],
    imports     : [
        RouterModule.forChild(tipoProductosRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class GestionTipoProductosModule
{
}
