...
import { manoObrasRoutes } from './gestion-mano-obra.routing';

@NgModule({
    declarations: [
        GestionManoObrasComponent,
        GestionManoObrasListComponent,
        GestionManoObrasDetailComponent,
    ],
    imports     : [
        RouterModule.forChild(manoObrasRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class GestionManoObraModule
{
}
