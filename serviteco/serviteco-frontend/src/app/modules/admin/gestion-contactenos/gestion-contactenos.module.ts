...
import { contactenosRoutes } from './gestion-contactenos.routing';

@NgModule({
    declarations: [
        GestionContactenosComponent,
        GestionContactenosListComponent,
        GestionContactenosDetailComponent,
    ],
    imports     : [
        RouterModule.forChild(contactenosRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class GestionContactenosModule
{
}
