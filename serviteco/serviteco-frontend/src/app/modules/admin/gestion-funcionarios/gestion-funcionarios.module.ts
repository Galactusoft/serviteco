...
import { funcionariosRoutes } from './gestion-funcionarios.routing';

@NgModule({
    declarations: [
        GestionFuncionariosComponent,
        GestionFuncionariosListComponent,
        GestionFuncionarioDetailComponent
...
export class GestionFuncionariosModule
{
}
