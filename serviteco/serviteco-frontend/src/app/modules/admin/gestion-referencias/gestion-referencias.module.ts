...
import { referenciasRoutes} from './gestion-referencias.routing';
import { BuscadorImportadorasComponent } from '../buscadores/buscador-importador/buscador-importador.component';

@NgModule({
    declarations: [
        GestionReferenciasComponent,
        GestionReferenciasListComponent,
        GestionReferenciasDetailComponent
    ],
    imports     : [
        RouterModule.forChild(referenciasRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class GestionReferenciasModule
{
}
