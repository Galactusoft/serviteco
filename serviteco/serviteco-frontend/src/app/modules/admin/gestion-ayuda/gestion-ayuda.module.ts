...
import { ayudaRoutes } from './gestion-ayuda.routing';

@NgModule({
    declarations: [
        GestionAyudaComponent,
        GestionAyudaListComponent,
        GestionAyudaDetailComponent,
    ],
    imports     : [
        RouterModule.forChild(ayudaRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
...
export class GestionAyudaModule
{
}
