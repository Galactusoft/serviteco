...
import { distribuidoresRoutes } from './gestion-distribuidores.routing';
...
@NgModule({
    declarations: [
        ...
        GestionDistribuidoresListComponent,
        GestionDistribuidoresDetailComponent,
        DialogMapaComponent
    ],
    imports     : [
        RouterModule.forChild(distribuidoresRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatDatepickerModule,
        MatDividerModule,
